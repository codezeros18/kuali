...
export const parsedOrders: Record<string, ParsedOrder> = {
  ...
  "chat-002": {
    ...
    deliveryDate: "Hari ini, 22 Mei 2026",
    deliveryTime: "12:00",
    paymentStatus: "unpaid",
    paymentNote: "-",
    pickupMethod: "pickup",
  ...
  "chat-003": {
    ...
    deliveryDate: "Jumat, 29 Mei 2026",
    deliveryTime: "10:00",
    paymentStatus: "unpaid",
    paymentNote: "Transfer dulu (belum dikonfirmasi)",
    pickupMethod: "delivery",
    confidenceScore: 92,
    missingFields: [],
    needsOwnerReview: false,
...
export const orders: Order[] = [
  ...
  {
    id: "ord-002",
    orderNumber: "KL-20260522-002",
    customerName: "Dinda Ayu",
    items: "Risol Mayo × 12",
    totalAmount: 42000,
    deliveryDate: "Sabtu, 23 Mei 2026",
    deliveryTime: "15:00",
    status: "confirmed",
    paymentStatus: "unpaid",
    confidenceScore: 95,
  ...
  {
    id: "ord-005",
    orderNumber: "KL-20260522-005",
    customerName: "Kak Ana",
    items: "Dessert Box × 3",
    totalAmount: 54000,
    deliveryDate: "Sabtu, 23 Mei 2026",
    deliveryTime: "09:00",
  ...
  {
    id: "ord-008",
    orderNumber: "KL-20260522-008",
    customerName: "Nisa Ramadhani",
    items: "Nasi Box Ayam × 2",
    totalAmount: 50000,
    deliveryDate: "Sabtu, 23 Mei 2026",
    deliveryTime: "10:00",
    status: "draft",
...
export const productionPlan: IngredientNeed[] = [
  {
    ...
    status: "sufficient",
    emoji: "🍚",
    fromOrders: "Nasi Box Ayam 20box × 150g",
  },
  {
    name: "Ayam Potong",
    needed: 20,
    ...
    status: "low",
    emoji: "🍗",
    fromOrders: "Nasi Box Ayam 20box × 1 potong",
  },
  {
    name: "Tepung Terigu",
    needed: 1.4,
    ...
    status: "sufficient",
    emoji: "🌾",
    fromOrders: "Risol 20pcs × 50g + Lumpia 10pcs × 40g",
  },
  {
    name: "Mayones",
    needed: 200,
  ...
  },
  {
    ...
    status: "sufficient",
    emoji: "🥚",
    fromOrders: "Risol 20pcs × 0.1 + Lumpia 10pcs × 0.2",
  },
  {
    name: "Bawang Putih",
    needed: 300,
    ...
    status: "insufficient",
    emoji: "🧄",
    fromOrders: "Nasi Box Ayam 20box × 15g",
  },
];
...
export const productionSummary = {
  ...
  fromOrders: 5,
  menuList: [
    { name: "Nasi Box Ayam", qty: 20, time: "06:00" },
    { name: "Risol Mayo", qty: 20, time: "07:00" },
    { name: "Lumpia Basah", qty: 10, time: "07:30" },
    { name: "Snack Box Mix", qty: 5, time: "08:00" },
    { name: "Dessert Box", qty: 3, time: "08:30" },
  ],
};
...
export const dailySummary = {
  ...
  totalChats: 15,
  narrative:
    "Hari ini 11 pesanan masuk. 5 sudah dikonfirmasi. 4 belum bayar — total Rp 167.000. Besok siapkan: 20 nasi box ayam, 20 risol, 10 lumpia, dan 5 snack box.",
};
